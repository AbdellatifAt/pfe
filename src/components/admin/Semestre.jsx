            ...
            <div className="all-Semester">
            {
                semester.map((S ,i)=>(
                    <div className="Semester sem" key={i}>
                            <Link to={`/Admin/SM_Module/`+S.id_semester} > {S.nom}</Link>
                            <div className="btns-semester">
                            <button onClick={()=>DeleteSemester(S.id_semester)} ><i className="fa fa-trash" aria-hidden="true"></i></button>
                            <button onClick={() => onModefier(S.id_semester)} className="btn_modifier"><i className="fas fa-edit"></i></button>
                            </div>
                    </div> 
                ))
            }
