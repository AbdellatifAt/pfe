...
useEffect(()=>{
    fetch( API_URL+'/Enseignant/Profile.php?cin='+cin)
    .then(res=>{
        if(res.status === 200 ){
            return res.json()
...
const HandlSubmit= async (e)=>{
    ...
    console.log(Object.fromEntries(formData));
            ...
            try{
                let res = await fetch(API_URL+'/Enseignant/ModifiePassWord.php',{
                    method:'POST' , 
                    body:formData 
                });
            ...
            <div className="content_profil_Etud">
                ...
                <div className="profil_Etud">
                    ...
                    <div className="iformation_detaill">
                        ...
                        <span> cin : </span><input value={profil.cin} readOnly />
                        </div>
                        <div className="detaill">
                                ...
                                <form  className="formulaire" ref={formElement} onSubmit={HandlSubmit}>
                                   {
                                    ...
                                    <div className="input-box">
                                        ...
                                        <input hidden  name="cin"  type="text" defaultValue={cin}  />
                                      

                                    <div >
                                        <input hidden type="reset" value='reset' id="resetInput" readOnly />
